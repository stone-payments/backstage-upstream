 ...
 */
import * as github from '@stone-payments/plugin-scaffolder-backend-module-github';
import * as gitlab from '@stone-payments/plugin-scaffolder-backend-module-gitlab';
import * as azure from '@stone-payments/plugin-scaffolder-backend-module-azure';
import * as bitbucket from '@stone-payments/plugin-scaffolder-backend-module-bitbucket';
...
import * as gerrit from '@stone-payments/plugin-scaffolder-backend-module-gerrit';

/**
 * @public
 * @deprecated use import from `@stone-payments/plugin-scaffolder-backend-module-github` instead
 */
...
/**
 * @public @deprecated use "createPublishBitbucketCloudAction" from \@stone-payments/plugin-scaffolder-backend-module-bitbucket-cloud or "createPublishBitbucketServerAction" from \@stone-payments/plugin-scaffolder-backend-module-bitbucket-server instead
 */
...
/**
 * @public
 * @deprecated use import from `@stone-payments/plugin-scaffolder-backend-module-azure` instead
 */
export const createPublishAzureAction = azure.createPublishAzureAction;

/**
 * @public
 * @deprecated use import from `@stone-payments/plugin-scaffolder-backend-module-gerrit` instead
 */
...
/**
 * @public
 * @deprecated use import from `@stone-payments/plugin-scaffolder-backend-module-gitlab` instead
 */
