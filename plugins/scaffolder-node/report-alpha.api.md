## API Report File for "@stone-payments/plugin-scaffolder-node"
...
import { TemplateFilter } from '@stone-payments/plugin-scaffolder-node';
import { TemplateGlobal } from '@stone-payments/plugin-scaffolder-node';
